...
# 4 "week10/parser/parser.mly"
       (string)
# 466 "week10/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 46 "week10/parser/parser.mly"
       ( [_1] )
# 471 "week10/parser/parser.ml"
         in
        _menhir_goto_id_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 5 "week10/parser/parser.mly"
       (int)
# 620 "week10/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 34 "week10/parser/parser.mly"
           ( Ast.Num _1 )
# 625 "week10/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week10/parser/parser.mly"
       (string)
# 716 "week10/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 35 "week10/parser/parser.mly"
       ( Ast.Id _1 )
# 721 "week10/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
