...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | OP_EQ
    | NUMBER of (
# 5 "week09/practice/parser/parser.mly"
       (int)
# 15 "week09/practice/parser/parser.ml"
  )
    | LSPAREN
    | KW_LET
    | KW_IN
    ...
    | KW_DEF
    | ID of (
# 4 "week09/practice/parser/parser.mly"
       (string)
# 25 "week09/practice/parser/parser.ml"
  )
    | EOF
...
let rec _menhir_goto_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState15 ->
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 21 "week09/practice/parser/parser.mly"
                          ( Ast.Add (_1, _3) )
# 66 "week09/practice/parser/parser.ml"
         in
    ...
    | MenhirState17 ->
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 22 "week09/practice/parser/parser.mly"
                           ( Ast.Sub (_1, _3) )
# 77 "week09/practice/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState13 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "week09/practice/parser/parser.mly"
       (string)
# 92 "week09/practice/parser/parser.ml"
            ))), _, (_3 : (Ast.expr))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _v : (Ast.expr) = 
# 19 "week09/practice/parser/parser.mly"
                            ( Ast.FCall (_1, _3) )
# 99 "week09/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week09/practice/parser/parser.mly"
       (string)
# 144 "week09/practice/parser/parser.ml"
        ))), _, (_4 : (Ast.expr))), _, (_6 : (Ast.expr))) = _menhir_stack in
        let _5 = () in
        let _3 = () in
        let _1 = () in
        let _v : (Ast.expr) = 
# 18 "week09/practice/parser/parser.mly"
                                    ( Ast.LetIn (_2, _4, _6) )
# 152 "week09/practice/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState8 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 26 "week09/practice/parser/parser.mly"
                         ( _2 )
# 170 "week09/practice/parser/parser.ml"
             in
    ...
    | MenhirState6 ->
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 27 "week09/practice/parser/parser.mly"
                                  ( Ast.Sub (Ast.Num 0, _3) )
# 195 "week09/practice/parser/parser.ml"
             in
            _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week09/practice/parser/parser.mly"
       (string)
# 216 "week09/practice/parser/parser.ml"
            ))), (_3 : (
# 4 "week09/practice/parser/parser.mly"
       (string)
# 220 "week09/practice/parser/parser.ml"
            ))), _, (_5 : (Ast.expr))) = _menhir_stack in
            let _6 = () in
            let _4 = () in
            let _1 = () in
            let _v : (Ast.fundef) = 
# 15 "week09/practice/parser/parser.mly"
                                   ( Ast.FDef (_2, _3, _5) )
# 228 "week09/practice/parser/parser.ml"
             in
    ...
    | MenhirState31 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, (_1 : (Ast.fundef))), _, (_2 : (Ast.expr))) = _menhir_stack in
            let _3 = () in
            let _v : (Ast.f1vae) = 
# 12 "week09/practice/parser/parser.mly"
                ( Ast.Prog (_1, _2) )
# 268 "week09/practice/parser/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_snd_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | EOF | KW_ENDEF | KW_IN | RSPAREN ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, (_1 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.expr) = 
# 20 "week09/practice/parser/parser.mly"
             ( _1 )
# 332 "week09/practice/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 5 "week09/practice/parser/parser.mly"
       (int)
# 415 "week09/practice/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 5 "week09/practice/parser/parser.mly"
       (int)
# 423 "week09/practice/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 25 "week09/practice/parser/parser.mly"
           ( Ast.Num _1 )
# 428 "week09/practice/parser/parser.ml"
     in
    _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week09/practice/parser/parser.mly"
       (string)
# 500 "week09/practice/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
    ...
    | EOF | KW_ENDEF | KW_IN | OP_MINUS | OP_PLUS | RSPAREN ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, (_1 : (
# 4 "week09/practice/parser/parser.mly"
       (string)
# 531 "week09/practice/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (Ast.expr) = 
# 28 "week09/practice/parser/parser.mly"
       ( Ast.Id _1 )
# 536 "week09/practice/parser/parser.ml"
         in
        _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 630 "week09/practice/parser/parser.ml"
