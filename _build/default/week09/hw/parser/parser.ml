...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | OP_COMMA
    | NUMBER of (
# 5 "week09/hw/parser/parser.mly"
       (int)
# 16 "week09/hw/parser/parser.ml"
  )
    | LSPAREN
    | KW_LET
    | KW_IN
    ...
    | KW_DEF
    | ID of (
# 4 "week09/hw/parser/parser.mly"
       (string)
# 26 "week09/hw/parser/parser.ml"
  )
    | EOF
...
# 17 "week09/hw/parser/parser.mly"
                   ( _1 :: _2 )
# 91 "week09/hw/parser/parser.ml"
         in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 107 "week09/hw/parser/parser.ml"
        ))), _, (_2 : (string list))) = _menhir_stack in
        let _v : (string list) = 
# 25 "week09/hw/parser/parser.mly"
             ( _1 :: _2 )
# 112 "week09/hw/parser/parser.ml"
         in
...
and _menhir_goto_decl : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.fundef) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | ID _ | KW_LET | LSPAREN | NUMBER _ | OP_MINUS ->
        ...
        let _v : (Ast.fundef list) = 
# 16 "week09/hw/parser/parser.mly"
         ( [_1] )
# 175 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_decl_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 37 "week09/hw/parser/parser.mly"
                        ( _1 :: _3 )
# 195 "week09/hw/parser/parser.ml"
         in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 210 "week09/hw/parser/parser.ml"
            ))), _, (_3 : (Ast.expr list))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _v : (Ast.expr) = 
# 30 "week09/hw/parser/parser.mly"
                             ( Ast.FCall (_1, _3) )
# 217 "week09/hw/parser/parser.ml"
             in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 232 "week09/hw/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 246 "week09/hw/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 24 "week09/hw/parser/parser.mly"
       ( [_1] )
# 251 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_plist _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
and _menhir_goto_snd_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | EOF | KW_ENDEF | KW_IN | OP_COMMA | RSPAREN ->
        ...
        let _v : (Ast.expr) = 
# 31 "week09/hw/parser/parser.mly"
             ( _1 )
# 310 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
and _menhir_goto_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState12 ->
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 32 "week09/hw/parser/parser.mly"
                          ( Ast.Add (_1, _3) )
# 332 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState14 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 33 "week09/hw/parser/parser.mly"
                           ( Ast.Sub (_1, _3) )
# 343 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState17 | MenhirState9 ->
        ...
        | RSPAREN ->
            ...
            let (_menhir_stack, _menhir_s, (_1 : (Ast.expr))) = _menhir_stack in
            let _v : (Ast.expr list) = 
# 36 "week09/hw/parser/parser.mly"
         ( [_1] )
# 376 "week09/hw/parser/parser.ml"
             in
            _menhir_goto_elist _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 421 "week09/hw/parser/parser.ml"
        ))), _, (_4 : (Ast.expr))), _, (_6 : (Ast.expr))) = _menhir_stack in
        let _5 = () in
        let _3 = () in
        let _1 = () in
        let _v : (Ast.expr) = 
# 28 "week09/hw/parser/parser.mly"
                                    ( Ast.LetIn (_2, _4, _6) )
# 429 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState4 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 41 "week09/hw/parser/parser.mly"
                         ( _2 )
# 447 "week09/hw/parser/parser.ml"
             in
    ...
    | MenhirState2 ->
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 42 "week09/hw/parser/parser.mly"
                                  ( Ast.Sub (Ast.Num 0, _3) )
# 472 "week09/hw/parser/parser.ml"
             in
            _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 493 "week09/hw/parser/parser.ml"
            ))), _), _, (_4 : (Ast.expr))) = _menhir_stack in
            let _5 = () in
            let _3 = () in
            let _1 = () in
            let _v : (Ast.fundef) = 
# 20 "week09/hw/parser/parser.mly"
                                  ( Ast.FDef (_2, [], _4) )
# 501 "week09/hw/parser/parser.ml"
             in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 522 "week09/hw/parser/parser.ml"
            ))), _, (_3 : (string list))), _, (_5 : (Ast.expr))) = _menhir_stack in
            let _6 = () in
            let _4 = () in
            let _1 = () in
            let _v : (Ast.fundef) = 
# 21 "week09/hw/parser/parser.mly"
                                        ( Ast.FDef (_2, _3, _5) )
# 530 "week09/hw/parser/parser.ml"
             in
            _menhir_goto_decl _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _2 = () in
            let _v : (Ast.f1vae) = 
# 12 "week09/hw/parser/parser.mly"
             ( Ast.Prog ([], _1) )
# 552 "week09/hw/parser/parser.ml"
             in
    ...
    | MenhirState42 ->
        ...
        | EOF ->
            ...
            let _3 = () in
            let _v : (Ast.f1vae) = 
# 13 "week09/hw/parser/parser.mly"
                       ( Ast.Prog (_1, _2) )
# 574 "week09/hw/parser/parser.ml"
             in
            _menhir_goto_main _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 5 "week09/hw/parser/parser.mly"
       (int)
# 684 "week09/hw/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 5 "week09/hw/parser/parser.mly"
       (int)
# 692 "week09/hw/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 40 "week09/hw/parser/parser.mly"
           ( Ast.Num _1 )
# 697 "week09/hw/parser/parser.ml"
     in
    _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 815 "week09/hw/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 845 "week09/hw/parser/parser.ml"
            ))) = _menhir_stack in
            let _3 = () in
            let _2 = () in
            let _v : (Ast.expr) = 
# 29 "week09/hw/parser/parser.mly"
                       ( Ast.FCall (_1, []) )
# 852 "week09/hw/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week09/hw/parser/parser.mly"
       (string)
# 864 "week09/hw/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (Ast.expr) = 
# 43 "week09/hw/parser/parser.mly"
       ( Ast.Id _1 )
# 869 "week09/hw/parser/parser.ml"
         in
        _menhir_goto_snd_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 923 "week09/hw/parser/parser.ml"
