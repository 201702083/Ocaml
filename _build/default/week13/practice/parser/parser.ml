...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | OP_AND
    | NUMBER of (
# 5 "week13/practice/parser/parser.mly"
       (int)
# 22 "week13/practice/parser/parser.ml"
  )
    | LSPAREN
    | LMPAREN
    | KW_TRUE
    ...
    | KW_ELSE
    | ID of (
# 4 "week13/practice/parser/parser.mly"
       (string)
# 33 "week13/practice/parser/parser.ml"
  )
    | EOF
    ...
    | MenhirState26 ->
        ...
        | RMPAREN ->
            ...
            | EOF | ID _ | KW_IF | RMPAREN ->
                ...
                let _1 = () in
                let _v : (Ast.stmt) = 
# 25 "week13/practice/parser/parser.mly"
                                                     ( Ast.IfStmt (_3, _6, None) )
# 116 "week13/practice/parser/parser.ml"
                 in
    ...
    | MenhirState34 ->
        ...
        | RMPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.stmt) = 
# 26 "week13/practice/parser/parser.mly"
                                                                                   ( Ast.IfStmt (_3, _6, Some _10) )
# 152 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_stmt _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 20 "week13/practice/parser/parser.mly"
               ( _1 :: _2 )
# 168 "week13/practice/parser/parser.ml"
         in
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _2 = () in
            let _v : (Ast.program) = 
# 17 "week13/practice/parser/parser.mly"
              ( Ast.Program _1 )
# 184 "week13/practice/parser/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_stmt : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.stmt) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | EOF | RMPAREN ->
        ...
        let _v : (Ast.stmt list) = 
# 21 "week13/practice/parser/parser.mly"
         ( [_1] )
# 221 "week13/practice/parser/parser.ml"
         in
        _menhir_goto_stmts _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState4 ->
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 33 "week13/practice/parser/parser.mly"
                         ( _2 )
# 402 "week13/practice/parser/parser.ml"
             in
    ...
    | MenhirState10 ->
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 34 "week13/practice/parser/parser.mly"
                                 ( Ast.Add (_1, _3) )
# 419 "week13/practice/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState12 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        | OP_AND | OP_OR | RSPAREN | SEMICOLON ->
            ...
            let _2 = () in
            let _v : (Ast.expr) = 
# 40 "week13/practice/parser/parser.mly"
                    ( Ast.Or (_1, _3) )
# 444 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState14 ->
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 35 "week13/practice/parser/parser.mly"
                                  ( Ast.Sub (_1, _3) )
# 461 "week13/practice/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState16 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        | OP_AND | OP_EQ | OP_GT | OP_LT | OP_OR | RSPAREN | SEMICOLON ->
            ...
            let _2 = () in
            let _v : (Ast.expr) = 
# 36 "week13/practice/parser/parser.mly"
                    ( Ast.Lt (_1, _3) )
# 480 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState18 ->
        ...
        | OP_AND | OP_EQ | OP_GT | OP_LT | OP_OR | RSPAREN | SEMICOLON ->
            ...
            let _2 = () in
            let _v : (Ast.expr) = 
# 37 "week13/practice/parser/parser.mly"
                    ( Ast.Gt (_1, _3) )
# 505 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState20 ->
        ...
        | OP_AND | OP_EQ | OP_OR | RSPAREN | SEMICOLON ->
            ...
            let _2 = () in
            let _v : (Ast.expr) = 
# 38 "week13/practice/parser/parser.mly"
                    ( Ast.Eq (_1, _3) )
# 534 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState22 ->
        ...
        | OP_AND | OP_OR | RSPAREN | SEMICOLON ->
            ...
            let _2 = () in
            let _v : (Ast.expr) = 
# 39 "week13/practice/parser/parser.mly"
                     ( Ast.And (_1, _3) )
# 565 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week13/practice/parser/parser.mly"
       (string)
# 649 "week13/practice/parser/parser.ml"
            ))), _, (_3 : (Ast.expr))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _v : (Ast.stmt) = 
# 24 "week13/practice/parser/parser.mly"
                                ( Ast.AssignStmt (_1, _3) )
# 656 "week13/practice/parser/parser.ml"
             in
            _menhir_goto_stmt _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 5 "week13/practice/parser/parser.mly"
       (int)
# 671 "week13/practice/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 5 "week13/practice/parser/parser.mly"
       (int)
# 679 "week13/practice/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 29 "week13/practice/parser/parser.mly"
           ( Ast.Num _1 )
# 684 "week13/practice/parser/parser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run5 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    let _1 = () in
    let _v : (Ast.expr) = 
# 31 "week13/practice/parser/parser.mly"
            ( Ast.Bool true )
# 717 "week13/practice/parser/parser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run6 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    let _1 = () in
    let _v : (Ast.expr) = 
# 32 "week13/practice/parser/parser.mly"
             ( Ast.Bool false )
# 729 "week13/practice/parser/parser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week13/practice/parser/parser.mly"
       (string)
# 736 "week13/practice/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "week13/practice/parser/parser.mly"
       (string)
# 744 "week13/practice/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 30 "week13/practice/parser/parser.mly"
       ( Ast.Var _1 )
# 749 "week13/practice/parser/parser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week13/practice/parser/parser.mly"
       (string)
# 847 "week13/practice/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 916 "week13/practice/parser/parser.ml"
